...
const docTemplate = `{
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateDepartmentParams"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateEmployeeParams"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handler.UpdateDepartmentParams": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
                ...
                "parent_id": {
                    "$ref": "#/definitions/handler.OptionalInt64"
                }
            }
        },
        "model.Department": {
